...
export const comments: Comment[] = [
  {
    ...
    postId: "p2",
    userId: "u2",
    text: "isso de mudar a ordem da integral é sofrido mesmo 😭 mas depois que encaixa, fica mais tranquilo!",
  ...
  },
  {
    ...
    postId: "p3",
    userId: "u1",
    text: "o Pitu claramente achando que ele está ajudando no estudo 🐱📚",
    createdAt: "2026-04-11T14:30:00Z",
    likes: 7,
  },
  {
